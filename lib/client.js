...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const requestCodec = { mode: "strict", typeSymbol: "dsh-spend#JsonRequest", create: () => requestSchema };
		const resultCodec = { mode: "strict", typeSymbol: "dsh-spend#JsonResult", create: () => jsonSchema };
