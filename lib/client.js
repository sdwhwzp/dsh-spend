...
.mono{font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:11px}
		...
		function Dashboard({ t, data, error, lastUpdated, onRefresh, onOpenDetails, cwd, onCwdChange }) {
								...
								error !== null
									...
									: totals === undefined || (data.callCount === 0 && data.personalBudget === null)
										...
										: react_jsx_runtime.jsx("div", {
											...
											children: [
												(data.personalBudget === null ? null : react_jsx_runtime.jsx("div", { className: "dsu-popItem", children: [react_jsx_runtime.jsx("span", { className: "dsu-popLabel", children: t("allowance.remaining") }), react_jsx_runtime.jsx("span", { className: "dsu-popValue isCost", children: data.personalBudget.budgetMicros === null ? t("allowance.unlimited") : formatCnyMicros(data.personalBudget.remainingMicros) })] })),
						...
						? react_jsx_runtime.jsx("div", {
							...
							children: [
								...
								react_jsx_runtime.jsx("div", {
									...
									children: react_jsx_runtime.jsx(Dashboard, { t, data, error, loading, lastUpdated, onRefresh: refresh, onOpenDetails: openDetails, cwd, onCwdChange: setCwd }),
								}),
							],
						})
						: null,
		...
		function apply(ctx) {
			...
			ctx.effect(() => {
				...
				root.render(react_jsx_runtime.jsx(UsageStatsWidget, { t, query }));
				return () => {
					root.unmount();
					container.remove();
				};
