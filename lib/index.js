...
let UsageStatsService = (() => {
  ...
  let _savePricing_decorators;
  let _deletePricing_decorators;
  return class UsageStatsService extends _classSuper {
    static {
      ...
      _savePricing_decorators = [Remote("savePricing")];
      __esDecorate(this, null, _savePricing_decorators, {
        kind: "method",
        name: "savePricing",
        static: false,
        private: false,
        access: { has: (obj) => "savePricing" in obj, get: (obj) => obj.savePricing },
        metadata: _metadata
      }, null, _instanceExtraInitializers);
      _deletePricing_decorators = [Remote("deletePricing")];
      __esDecorate(this, null, _deletePricing_decorators, {
        kind: "method",
        name: "deletePricing",
        static: false,
        private: false,
        access: { has: (obj) => "deletePricing" in obj, get: (obj) => obj.deletePricing },
        metadata: _metadata
      }, null, _instanceExtraInitializers);
    ...
    static Config = z.object({
      ...
      priceVersion: z.string().default("2026-08-22"),
    ...
    constructor(ctx, config = {}) {
      ...
      this.ledger = new SpendLedger(config.ledgerPath ?? dshHomePath("spend-ledger.sqlite"), {
        ...
        priceVersion: config.priceVersion ?? "2026-08-22",
