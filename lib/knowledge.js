 ...
 * pricing (verified from official docs, 2026-08-27; DeepSeek, Zhipu and
 * OpenAI re-verified 2026-09-11):
 *
 *   OpenCode Go  — $10/month subscription, no introductory rate (the $5 first
 *                  month is gone as of 2026-09-14). Usage is dollar-capped PER
 *                  MODEL: each model carries a monthly cap of $15, $30 or $60,
 *                  and the shorter windows are fractions of it — "5-hour — 20%
 *                  of the monthly limit; weekly — 50%; and monthly — 100%".
 *                  Per-model caps and request estimates: OPENCODE_GO_MODELS.
 ...
 *   Z.AI API     — pay-as-you-go GLM token billing, including cached input.
...
const DEEPSEEK_V4_PRO_PRICING = {
  ...
  schedule: {
    phases: [
      ...
      {
        // Same 2026-09-10 12:00 republication as Flash: CNY 0.30 cache-hit /
        // 9 cache-miss / 27 output at peak, off-peak half, peak narrowed to
        // weekdays (official: https://api-docs.deepseek.com/zh-cn/quick_start/pricing/,
        // verified 2026-09-11). Converted at the deployment's 7.2 CNY rate.
        effectiveAt: "2026-09-10T12:00:00+08:00",
        peakHours: [[9, 12], [14, 18]],
        peakDays: [1, 2, 3, 4, 5],
        peak: { inputPerMillion: 1.25, outputPerMillion: 3.75, cacheReadPerMillion: 0.041667, cacheWritePerMillion: 0 },
        offPeak: { inputPerMillion: 0.625, outputPerMillion: 1.875, cacheReadPerMillion: 0.020833, cacheWritePerMillion: 0 },
      },
    ],
  },
};
...
/**
 * DeepSeek Flash, priced in USD at the deployment's 7.2 CNY rate.
 *
 * Two published tables apply in sequence. From 2026-08-17 peak/off-peak began
 * and peaked EVERY day. From 2026-09-10 12:00 (Beijing) DeepSeek cut the
 * off-peak rate to CNY 0.02 cache-hit / 1 cache-miss / 4 output per million,
 * kept peak at twice off-peak, and narrowed the peak to WEEKDAYS. The base
 * fields below are the pre-2026-08-17 flat rate, which prices older calls.
 */
const DEEPSEEK_FLASH_PRICING = {
  ...
  schedule: {
    phases: [
      ...
      },
      {
        ...
        peakHours: [[9, 12], [14, 18]],
        peakDays: [1, 2, 3, 4, 5],
        peak: { inputPerMillion: 0.277778, outputPerMillion: 1.111111, cacheReadPerMillion: 0.005556, cacheWritePerMillion: 0 },
        offPeak: { inputPerMillion: 0.138889, outputPerMillion: 0.555556, cacheReadPerMillion: 0.002778, cacheWritePerMillion: 0 },
      },
    ],
  },
};

const GLM_5_3_FLASH_PRICING = {
  inputPerMillion: 0.075,
  outputPerMillion: 0.25,
  cacheReadPerMillion: 0.015,
  cacheWritePerMillion: 0,
  schedule: {
    endsAt: "2026-09-10T00:00:00+08:00",
    after: {
...
/**
 * The Go plan's published per-model limits (verified 2026-09-14).
 *
 * Every model carries its own monthly dollar cap; the plan price buys access,
 * not a shared pool. `requests` are the vendor's own estimates for that model
 * and vary by two orders of magnitude across the catalog (110 per 5h for Kimi
 * K3, 45,300 for Muse Spark), which is why no single request number can stand
 * for the provider.
 *
 * Keys are the catalog's display names slugified, which is how the same models
 * appear in session logs (`deepseek-v4-pro`, `glm-5.3-flash`, `grok-4.6`).
 */
export const OPENCODE_GO_MODELS = {
  "glm-5.3-flash": { label: "GLM-5.3-Flash", dollarsPerMonth: 60, requests: { per5h: 6320, perWeek: 15790, perMonth: 31580 } },
  "glm-5.3": { label: "GLM-5.3", dollarsPerMonth: 15, requests: { per5h: 220, perWeek: 540, perMonth: 1080 } },
  "glm-5.2": { label: "GLM-5.2", dollarsPerMonth: 60, requests: { per5h: 880, perWeek: 2150, perMonth: 4300 } },
  "glm-5.1": { label: "GLM-5.1", dollarsPerMonth: 60, requests: { per5h: 880, perWeek: 2150, perMonth: 4300 } },
  "kimi-k3": { label: "Kimi K3", dollarsPerMonth: 15, requests: { per5h: 110, perWeek: 250, perMonth: 490 } },
  "kimi-k2.7-code": { label: "Kimi K2.7 Code", dollarsPerMonth: 60, requests: { per5h: 1350, perWeek: 3380, perMonth: 6750 } },
  "kimi-k2.6": { label: "Kimi K2.6", dollarsPerMonth: 60, requests: { per5h: 1150, perWeek: 2880, perMonth: 5750 } },
  "longcat-2.0": { label: "LongCat-2.0", dollarsPerMonth: 60, requests: { per5h: 11400, perWeek: 28600, perMonth: 57200 } },
  "mimo-v2.5": { label: "MiMo V2.5", dollarsPerMonth: 60, requests: { per5h: 30100, perWeek: 75200, perMonth: 150400 } },
  "mimo-v2.5-pro": { label: "MiMo V2.5 Pro", dollarsPerMonth: 15, requests: { per5h: 3250, perWeek: 8150, perMonth: 16300 } },
  "minimax-m3": { label: "MiniMax M3", dollarsPerMonth: 60, requests: { per5h: 3200, perWeek: 8000, perMonth: 16000 } },
  "minimax-m2.7": { label: "MiniMax M2.7", dollarsPerMonth: 60, requests: { per5h: 3400, perWeek: 8500, perMonth: 17000 } },
  "muse-spark-1.3-contributor": { label: "Muse Spark 1.3 Contributor", dollarsPerMonth: 60, requests: { per5h: 45300, perWeek: 113300, perMonth: 226600 } },
  "muse-spark-1.2-contributor": { label: "Muse Spark 1.2 Contributor", dollarsPerMonth: 60, requests: { per5h: 45300, perWeek: 113300, perMonth: 226600 } },
  "qwen3.8-max": { label: "Qwen3.8 Max", dollarsPerMonth: 15, requests: { per5h: 160, perWeek: 400, perMonth: 810 } },
  "qwen3.8-flash": { label: "Qwen3.8 Flash", dollarsPerMonth: 30, requests: { per5h: 5400, perWeek: 13500, perMonth: 27000 } },
  "qwen3.7-max": { label: "Qwen3.7 Max", dollarsPerMonth: 30, requests: { per5h: 170, perWeek: 420, perMonth: 840 } },
  "qwen3.7-plus": { label: "Qwen3.7 Plus", dollarsPerMonth: 60, requests: { per5h: 4300, perWeek: 10800, perMonth: 21600 } },
  "qwen3.6-plus": { label: "Qwen3.6 Plus", dollarsPerMonth: 60, requests: { per5h: 3300, perWeek: 8200, perMonth: 16300 } },
  "deepseek-v4.1-flash": { label: "DeepSeek V4.1 Flash", dollarsPerMonth: 60, requests: { per5h: 6500, perWeek: 16250, perMonth: 32500 } },
  "deepseek-v4-pro": { label: "DeepSeek V4 Pro", dollarsPerMonth: 15, requests: { per5h: 1050, perWeek: 2600, perMonth: 5200 } },
  "deepseek-v4-flash": { label: "DeepSeek V4 Flash", dollarsPerMonth: 30, requests: { per5h: 13000, perWeek: 32500, perMonth: 65000 } },
  "deepseek-v4-flash-vision-exp": { label: "DeepSeek V4 Flash Vision Exp", dollarsPerMonth: 15, requests: { per5h: 6500, perWeek: 16250, perMonth: 32500 } },
  "hy4-preview": { label: "Hy4 preview", dollarsPerMonth: 30, requests: { per5h: 1350, perWeek: 3380, perMonth: 6770 } },
  "hy3": { label: "Hy3", dollarsPerMonth: 60, requests: { per5h: 4300, perWeek: 10750, perMonth: 21500 } },
  "grok-4.6": { label: "Grok 4.6", dollarsPerMonth: 15, requests: { per5h: 169, perWeek: 423, perMonth: 845 } },
  "gpt-5.6-luna": { label: "GPT 5.6 Luna", dollarsPerMonth: 15, requests: { per5h: 2050, perWeek: 5100, perMonth: 10250 } },
};

/** The plan's published window rule: 5h is 20% of the monthly cap, a week 50%. */
export const OPENCODE_GO_WINDOW_SHARE = { per5h: 0.2, perWeek: 0.5, perMonth: 1 };

/**
 * Dollar caps for one Go model, or for the catalog's most generous tier when
 * the model is unknown.
 * @param {string} [model] - model id as session logs spell it.
 * @returns {{dollarsPer5h: number, dollarsPerWeek: number, dollarsPerMonth: number}} the window caps.
 */
export function opencodeGoCaps(model) {
  const known = model === undefined ? undefined : OPENCODE_GO_MODELS[String(model).toLowerCase()];
  const monthly = known?.dollarsPerMonth
    ?? Math.max(...Object.values(OPENCODE_GO_MODELS).map(entry => entry.dollarsPerMonth));
  return {
    dollarsPer5h: monthly * OPENCODE_GO_WINDOW_SHARE.per5h,
    dollarsPerWeek: monthly * OPENCODE_GO_WINDOW_SHARE.perWeek,
    dollarsPerMonth: monthly * OPENCODE_GO_WINDOW_SHARE.perMonth,
  };
}
...
export const PROVIDER_KNOWLEDGE = {
  "opencode-go": {
    ...
    plan: {
      ...
      // unreachable. The caps are per model and this row is per provider, so
      // it carries the catalog's most generous tier and says so: a $15 model
      // spends its month four times faster than this row suggests. No request
      // count belongs here either — the vendor's own estimates span 490 to
      // 226,600 requests a month across the catalog.
      quota: {
        ...opencodeGoCaps(),
        note: "各模型月上限 $15/$30/$60 不等，此行按最高档 $60 显示；5h = 月额度 20%，周 = 50%。实际额度以 Provider 实时用量为准。",
      },
    },
    // Token rates the plan charges each model's dollar cap against (models.dev
    // `opencode-go` provider, fetched 2026-09-14). This is the plan's own
    // catalog, not the Zen pay-as-you-go card: the same model is priced
    // differently on the two products (DeepSeek V4 Pro is $0.66/$1.98 here
    // against Zen's $1.74/$3.48), so reading rates off the Zen docs page would
    // misprice every Go call. Confirmed against the one row the dashboard
    // already priced: gpt-5.6-luna 0.2/1.2/0.02/0.25 renders as
    // ¥1.44/¥8.64/¥0.144/¥1.80 at 7.2 CNY/USD, which is what it shows.
    rates: [
      { model: "deepseek-v4-flash", inputPerMillion: 0.15, outputPerMillion: 0.6, cacheReadPerMillion: 0.003, cacheWritePerMillion: 0 },
      { model: "deepseek-v4-flash-vision-exp", inputPerMillion: 0.15, outputPerMillion: 0.6, cacheReadPerMillion: 0.003, cacheWritePerMillion: 0 },
      { model: "deepseek-v4-pro", inputPerMillion: 0.66, outputPerMillion: 1.98, cacheReadPerMillion: 0.022, cacheWritePerMillion: 0 },
      { model: "deepseek-v4.1-flash", inputPerMillion: 0.15, outputPerMillion: 0.6, cacheReadPerMillion: 0.003, cacheWritePerMillion: 0 },
      { model: "glm-5", inputPerMillion: 1, outputPerMillion: 3.2, cacheReadPerMillion: 0.2, cacheWritePerMillion: 0 },
      ...
      { model: "glm-5.3", inputPerMillion: 1.4, outputPerMillion: 4.4, cacheReadPerMillion: 0.26, cacheWritePerMillion: 0 },
      { model: "glm-5.3-flash", inputPerMillion: 0.15, outputPerMillion: 0.5, cacheReadPerMillion: 0.03, cacheWritePerMillion: 0 },
      ...
      { model: "hy3", inputPerMillion: 0.14, outputPerMillion: 0.58, cacheReadPerMillion: 0.035, cacheWritePerMillion: 0 },
      { model: "hy4-preview", inputPerMillion: 0.834, outputPerMillion: 2.501, cacheReadPerMillion: 0.042, cacheWritePerMillion: 0 },
      { model: "kimi-k2.5", inputPerMillion: 0.6, outputPerMillion: 3, cacheReadPerMillion: 0.1, cacheWritePerMillion: 0 },
      { model: "kimi-k2.6", inputPerMillion: 0.95, outputPerMillion: 4, cacheReadPerMillion: 0.16, cacheWritePerMillion: 0 },
      { model: "kimi-k2.7-code", inputPerMillion: 0.95, outputPerMillion: 4, cacheReadPerMillion: 0.19, cacheWritePerMillion: 0 },
      { model: "kimi-k3", inputPerMillion: 3, outputPerMillion: 15, cacheReadPerMillion: 0.3, cacheWritePerMillion: 0 },
      { model: "longcat-2.0", inputPerMillion: 0.3, outputPerMillion: 1.2, cacheReadPerMillion: 0.006, cacheWritePerMillion: 0 },
      { model: "mimo-v2-omni", inputPerMillion: 0.4, outputPerMillion: 2, cacheReadPerMillion: 0.08, cacheWritePerMillion: 0 },
      { model: "mimo-v2-pro", inputPerMillion: 1, outputPerMillion: 3, cacheReadPerMillion: 0.2, cacheWritePerMillion: 0 },
      { model: "mimo-v2.5", inputPerMillion: 0.14, outputPerMillion: 0.28, cacheReadPerMillion: 0.0028, cacheWritePerMillion: 0 },
      { model: "mimo-v2.5-pro", inputPerMillion: 0.435, outputPerMillion: 0.87, cacheReadPerMillion: 0.003625, cacheWritePerMillion: 0 },
      { model: "minimax-m2.5", inputPerMillion: 0.3, outputPerMillion: 1.2, cacheReadPerMillion: 0.03, cacheWritePerMillion: 0 },
      { model: "minimax-m2.7", inputPerMillion: 0.3, outputPerMillion: 1.2, cacheReadPerMillion: 0.06, cacheWritePerMillion: 0 },
      { model: "minimax-m3", inputPerMillion: 0.3, outputPerMillion: 1.2, cacheReadPerMillion: 0.06, cacheWritePerMillion: 0 },
      { model: "muse-spark-1.2-contributor", inputPerMillion: 0.1, outputPerMillion: 0.2, cacheReadPerMillion: 0.002, cacheWritePerMillion: 0 },
      { model: "muse-spark-1.3-contributor", inputPerMillion: 0.1, outputPerMillion: 0.2, cacheReadPerMillion: 0.002, cacheWritePerMillion: 0 },
      { model: "omen-alpha", inputPerMillion: 0.2, outputPerMillion: 0.66, cacheReadPerMillion: 0.04, cacheWritePerMillion: 0 },
      { model: "ox-alpha-free", inputPerMillion: 0, outputPerMillion: 0, cacheReadPerMillion: 0, cacheWritePerMillion: 0 },
      { model: "qwen3.5-plus", inputPerMillion: 0.2, outputPerMillion: 1.2, cacheReadPerMillion: 0.02, cacheWritePerMillion: 0.25 },
      { model: "qwen3.6-plus", inputPerMillion: 0.5, outputPerMillion: 3, cacheReadPerMillion: 0.05, cacheWritePerMillion: 0.625 },
      { model: "qwen3.7-max", inputPerMillion: 2.5, outputPerMillion: 7.5, cacheReadPerMillion: 0.5, cacheWritePerMillion: 3.125 },
      { model: "qwen3.7-plus", inputPerMillion: 0.4, outputPerMillion: 1.6, cacheReadPerMillion: 0.04, cacheWritePerMillion: 0.5 },
      { model: "qwen3.8-flash", inputPerMillion: 0.15, outputPerMillion: 0.47, cacheReadPerMillion: 0.016, cacheWritePerMillion: 0.2 },
      { model: "qwen3.8-max", inputPerMillion: 2, outputPerMillion: 6, cacheReadPerMillion: 0.25, cacheWritePerMillion: 2.5 },
    ],
  },
  "openai-codex": {
    label: "OpenAI Codex",
    ...
    rates: [
      ...
      { model: "gpt-5.6-sol", inputPerMillion: 4, outputPerMillion: 20, cacheReadPerMillion: 0.4, cacheWritePerMillion: 5 },
  ...
  deepseek: {
    ...
    rates: [
      ...
      {
        // DeepSeek prices the experimental vision route at the text Flash rate;
        // an image costs at most 384 tokens and carries no separate premium.
        model: "deepseek-v4-flash-vision-exp",
        ...DEEPSEEK_FLASH_PRICING,
      },
      {
        // The dated 4.1 preview bills at the same Flash rate.
        model: "deepseek-v4.1-flash-expires-on-0910",
        ...DEEPSEEK_FLASH_PRICING,
      },
      {
        // The official catalog now names this route `deepseek-flash`; a log
        // written under the new id must not fall through to the default row.
  ...
  "kimi-coding": {
    label: "Kimi 编程套餐",
    plan: { type: "code" },
    // Internal customer allocation rates, not an additional charge on top of
    // the coding subscription. Kimi publishes two tables and this provider
    // routes to both (platform.kimi.com, 2026-09-09):
    //   K2.7 Code, 256k context — CNY 1.30 cache-hit / 6.50 miss / 27 output
    //   K2.7 Code HighSpeed, 256k — CNY 2.60 / 13 / 54, twice the standard
    //   K3, 1M context, no tier — CNY 2 cache-hit / 20 miss / 100 output
    // `kimi-for-coding` is the subscription's coding route and bills at the
    // K2.7 Code rate; the routes named for K3 bill at the K3 rate. Both reuse
    // the metered `moonshot` numbers so one model has one rate here.
    // Model matching is exact, so each route carries both the subscription's
    // own name and the API id the same model is published under.
    rates: [
      { model: "kimi-for-coding", inputPerMillion: 0.92, outputPerMillion: 3.8, cacheReadPerMillion: 0.18, cacheWritePerMillion: 0 },
      { model: "kimi-k2.7-code", inputPerMillion: 0.92, outputPerMillion: 3.8, cacheReadPerMillion: 0.18, cacheWritePerMillion: 0 },
      { model: "kimi-for-coding-highspeed", inputPerMillion: 1.83, outputPerMillion: 7.61, cacheReadPerMillion: 0.37, cacheWritePerMillion: 0 },
      ...
      { model: "k3-256k", inputPerMillion: 2.82, outputPerMillion: 14.08, cacheReadPerMillion: 0.28, cacheWritePerMillion: 0 },
      { model: "k3", inputPerMillion: 2.82, outputPerMillion: 14.08, cacheReadPerMillion: 0.28, cacheWritePerMillion: 0 },
    ],
  },
  moonshot: {
    label: "Moonshot Kimi",
  ...
  zhipu: {
    ...
    plan: { type: "token" },
    rates: [
      // International (z.ai) USD rates; cache storage is currently free (0).
      // GLM-5.3-Flash is 50% off through 2026-09-09 24:00 UTC+8.
      ...
      { model: "glm-5v-turbo", inputPerMillion: 1.2, outputPerMillion: 4.0, cacheReadPerMillion: 0.24, cacheWritePerMillion: 0 },
  ...
  "opencode-zen": {
    ...
    rates: [
      ...
      { model: "gpt-6-astra", inputPerMillion: 10, outputPerMillion: 50, cacheReadPerMillion: 1, cacheWritePerMillion: 0 },
      { model: "gpt-5.6-sol", inputPerMillion: 4, outputPerMillion: 20, cacheReadPerMillion: 0.4, cacheWritePerMillion: 0 },
