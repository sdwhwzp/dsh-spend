...
export const PROVIDER_KNOWLEDGE = {
  ...
  "kimi-coding": {
    ...
    // the coding subscription. Kimi publishes one K3 rate with no context
    // tier (CNY 2 cache-hit / 20 cache-miss / 100 output per million,
    // platform.kimi.com 2026-09-09), so the subscription's routes bill at the
    // same rate as the metered `moonshot` K3 row.
    rates: [
      { model: "kimi-for-coding", inputPerMillion: 2.82, outputPerMillion: 14.08, cacheReadPerMillion: 0.28, cacheWritePerMillion: 0 },
